...
var cheeseArray = document.getElementsByClassName("Cheese");
	...
	for (var k = 0; k < cheeseArray.length; k++){
		if (cheeseArray[k].checked) {
			var cheeseType = cheeseArray[k].value;
			text1=text1+cheeseType+"<br>"
		}
	}
	...
	console.log("total after cheese " + runningTotal);
...
var crustType = ""
	...
	for (var m=0;m<crustArray.length; m++){
		if (crustArray[m].checked) {
			crustType = crustArray[m].value
			text1= text1+crustType + "<br>";
		}
	}
